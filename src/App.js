...
class App extends Component {
  ...
  render() {
    const { auth, loadingUser } = this.props;
    return (
      <div>
        {auth.uid !== undefined ? (
          <div>
          ...
          >
            ...
            <Grid container spacing={0} style={{ height: "88vh" }}>
              <Grid
                ...
                md={8}
                xs={12}
                style={{ textAlign: "center", overflowY: "auto !important" }}
              >
                ...
                <Button
                  ...
                  onClick={this.handelDialogClose}
                >
                  سجل الان
                </Button>
              </Grid>
        ...
        {loadingUser === true ? (
          <Dialog disableBackdropClick maxWidth="xs" fullWidth open={true}>
            <DialogContent style={{ background: "transparent",height : 300,display :"flex", justifyContent : "center" }}>
